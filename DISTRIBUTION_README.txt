TrajPlayer v0.1.0-alpha.13 distribution
...
- Export the current frame as XYZ/extXYZ, the current viewport or analysis plot as PNG, the current molecular viewport as editable vector SVG, and complete analysis values as CSV.
