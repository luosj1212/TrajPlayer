...
1. Open GitHub Releases and download
   `TrajPlayer-Windows-x64-v0.1.0-alpha.14.zip`, not the source-code ZIP.
...
Download `TrajPlayer-Linux-x86_64-v0.1.0-alpha.14.tar.gz` from GitHub Releases
...
- Apple Silicon (M1 or newer):
  `TrajPlayer-macOS-arm64-v0.1.0-alpha.14.zip`
- Intel Mac: `TrajPlayer-macOS-x86_64-v0.1.0-alpha.14.zip`
